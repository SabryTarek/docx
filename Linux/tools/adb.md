adb (Android Developer Briage)
==============================

# Android provides most of the usual Unix command-line tools. For a list of available tools, use the following command: adb shell ls /system/bin
...
maximum length of three minutes.
...
package manager (pm): tool to perform actions and queries on app packages installed on the device. While in a shell
sqlite3
...
am start -n
am start -a android.intent.action.VIEW -d "file:///mnt/sdcard/IMG-20191126-WA0000.jpg"
...
- Android SDK Platform-Tools
    ...
    - fastboot
    - systrace
    # Platform-Tools includes tools that interface with the Android platform
